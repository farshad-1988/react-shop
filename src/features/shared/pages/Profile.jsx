    ...
    <>
      <div className="row">
        <div className="d-flex flex-column align-item-center col-12 col-xl-6">
          {!currentUser || !userDoc ? (
            <span className="spinner spinner-border align-self-center mt-4"></span>
          ) : (
            <div>
              ...
              <div className="container m-3 h-auto ff-profile-address-box">
                {userDoc.address ? (
                  <div className="row border border-secondary rounded text-capitalize lh-base p-3">
                    <span>{address1}</span>
                  ...
                  <span className="text-danger">
                    please click on edit button and complete your information
                  </span>
                )}
        ...
        <div className="col-12 col-xl-6">
          {allCompletedPurchase ? (
            Object.entries(sortedPurchased)?.map(
              (allPurchasedItemsInfo, index) => {
                return (
                  <PurchasedItems
                    allPurchasedItemsInfo={allPurchasedItemsInfo}
          ...
          {allCompletedPurchase?.length === 0 && (
            <div className="text-center mt-5 text-danger">
              you don't have any completed purchase.
            </div>
          )}
        </div>
      </div>
